        ...
        <div class="sr">
            <div class="page-hero page-container">
                ...
                <div class="p-5 pos-rlt text-center">
                    <h1 class="display-3 font-weight-bold text-white mb-5 mx-5">@yield('HeaderContent')</h1>
                    <a href="discover" class="btn btn-md gd-primary text-white no-ajax m-2">Discover new Artists</a>
            ...
            <div class="page-container p-5 pos-rlt">
                <div class="py-5 text-center">
                    <h2 class="display-4 font-weight-bold text-white mb-5">Artists on Bepop</h2>
                    <p>Find the most popular artists and listen their music on Bepop, Create your own playlist when listening to them.</p>
                    <div class="py-4">
                        <a href="html/artists.html" class="btn btn-md btn-outline-primary no-ajax m-2">Explore artists</a>
            ...
            <div class="row no-gutters flex align-items-end">
                <div class="col-2">
                    <div class="row no-gutters align-items-end">
                        <div class="col-2">
                            <div class="media">
                                <a class="media-content" style="background-image: url(assets/img/b0.jpg);"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="media">
                                <a class="media-content" style="background-image: url(assets/img/b3.jpg);"></a>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="media">
                ...
                <div class="col-3">
                    <div class="row no-gutters align-items-end">
                        <div class="col-3">
                            <div class="media">
                                <a class="media-content" style="background-image: url(assets/img/b6.jpg);"></a>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="media">
                ...
                <div class="col-3">
                    <div class="row no-gutters align-items-end">
                        ...
                        <div class="col-5">
                            <div class="media">
                                <a class="media-content" style="background-image: url(assets/img/b10.jpg);"></a>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="media">
                        ...
                        <div class="col-6">
                            <div class="media">
                                <a class="media-content" style="background-image: url(assets/img/b12.jpg);"></a>
                            </div>
                        </div>
                    </div>
                </div>
